...
urlpatterns = [
    ...
    path('admin-view/seating/', views.admin_seating_view, name='admin_seating'),
    path('admin-view/circulars/', views.admin_circulars, name='admin_circulars'),
    path('admin-view/circulars/add/', views.admin_add_circular, name='admin_add_circulars'),
